/**
 * Leaves v0.2
 * By mufeng, https://chenyu.me, 2021/07/06
 */
~(function(doc) {
	...
	FallingLeaves.prototype = {
		init: function() {
			...
			if (this.support != false) {
				...
				var bgdiv = doc.createElement('div');
				bgdiv.className = 'leave-bg';
		...
		imgurl: function() {
			...
			while (i <= len && got == -1) {
				var js_url = doc.getElementsByTagName('script')[i].src,
					got = js_url.indexOf('cymeihua.js');
				i++
			}
			return js_url.replace('cymeihua.js', 'images/')
		},
