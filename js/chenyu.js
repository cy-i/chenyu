    $(document).ready(function () {
     ...
     // }
      ...
      //询问框
      layer.confirm('<div style="padding:20px; line-height:30px; color: #000; text-align:center;"><p>最怕问初衷，大梦成空。</p><p>眉间鬓上老英雄，剑甲鞮鍪封厚土，说甚擒龙。 </p><p>壮志付西风，逝去无踪。</p><p>少年早作一闲翁，诗酒琴棋终日里，岁月匆匆。</p></div>', {
        btn: ['对不起','寒山别哭'] //按钮
      }, function(){
        layer.msg('<div style="padding:20px; line-height:30px; color: #000; text-align:center;"><p>我怀念的不是哪个人，而是我那回不去的曾经，</p><p>突然很想跟自己说声对不起，对不起再也找不回原来的自己了。</p></div>', {icon: 1});
      }, function(){
